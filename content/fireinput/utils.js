...
var FireinputUtils = 
{
    ...
    insertCharAtCaret: function (element, text) 
    {
       if(!element)
          return; 
	  ...
	  if(start != null) 
	  {
       ...
       else if(element.documentTarget)
       {
          ...
          FireinputLog.debug(this, "selection.anchorNode.nodeType: " + selection.anchorNode.nodeType);
          FireinputLog.debug(this, "selection.anchorNode.nodeName: " + selection.anchorNode.nodeName);
          FireinputLog.debug(this, "selection.anchorOffset: " + selection.anchorOffset); 
          FireinputLog.debug(this, "selection.isCollapsed: " + selection.isCollapsed); 
          FireinputLog.debug(this, "selection.rangeCount: " + selection.rangeCount); 
          ...
          if (selection.focusNode.nodeType == Node.TEXT_NODE)
          {
             ...
             FireinputLog.debug(this, "nodeValue: " + nodeValue);
          ...
          {
             this.insertAtSelection(selection, text);
          }
       }
       else 
       {
    ...
    insertAtSelection: function(selection, text)
    {
       ...
       if (canInsert)
       {
          ...
          var tmpNode = doc.createTextNode(text);
    ...
    getDocumentScrollLeft: function(window)
    {
       if(!window) 
          return 0; 
       return window.top.document.documentElement.scrollLeft || window.top.document.body.scrollLeft; 
    }, 
