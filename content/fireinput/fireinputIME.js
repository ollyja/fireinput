...
FireinputIME.prototype = 
{
    ...
    {
       return FireinputUtils.getUserFile("smart_pinyin_table");
    },

    getNetPinyinPhraseFile: function()
    {
       return FireinputUtils.getUserFile("smart_pinyin_phrase");
    },

    getNetWubi86File: function()
    {
       return FireinputUtils.getUserFile("wubi86_table");
    },

    getNetWubi98File: function()
    {
       return FireinputUtils.getUserFile("wubi98_table");
    },

    getNetCangjie5File: function()
    {
       return FireinputUtils.getUserFile("cangjie5_table");
    },

    getNetZhengmaFile: function()
    {
       return FireinputUtils.getUserFile("zhengma_table");
    },
    ...
    {
       return FireinputUtils.getUserFile("userwordtable.fireinput");
    }, 

    getExtDataFile: function()
    {
       return FireinputUtils.getUserFile("extwordtable.fireinput");
    },
 
    getUserHistoryFile: function()
    {
       return FireinputUtils.getUserFile("userhistory.fireinput.rdf");
    }, 
