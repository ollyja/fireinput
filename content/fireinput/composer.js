...
var FireinputComposer = 
{
    ...
    createComposePanel: function(autoselected, result)
    {
       ...
       if(this.composedNumber >= wlist.length)
       {
          ...
          element.style.width = 12 * result.value.length + "px"; 
    ...
    showWordEditor: function(e)
    {
       ...
       target.style.width = 12 * target.getAttribute("hiddeninputkey").length + "px";
    ...
    updateWordEditor: function(e)
    {
       ...
       target.style.width = (12 * target.value.length < 20 ? 20 : 12 * target.value.length) + "px";
       Fireinput.findCharWithKey(target.value); 
    }, 
    ...
    hideWordEditor: function(e)
    {
       ...
       if(target.value == target.getAttribute("hiddeninputkey"))
       {
          ...
          target.style.width = 12 * target.getAttribute("hiddenvalue").length + "px";
          return;
       }
       ...
       {
          target.value = target.getAttribute("hiddenvalue"); 
          target.style.width = 12 * target.getAttribute("hiddenvalue").value.length + "px";
          return; 
       }

       target.value = charResult.value; 
       target.style.width = 12 * charResult.value.length + "px";
    ...
    hideComposeEditorWithValue: function(editorBox, autoselected, charResult)
    {
       ...
       editorBox.style.width = 12 * charResult.value.length + "px";
